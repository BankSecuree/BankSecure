...
function atualizarGrafico() {
  ...
  let processo = document.getElementById("selectProcesso").value

  console.log("Processo: ", processo);
  console.log("Agencia: ", agencia);

  fetch("/dashAnalistaProcesso/dadosAnalista", {
    method: "POST",
    headers: {
...
function atualizarCards() {
  dadoSO = document.getElementById("h4-so");
  alertaSO = document.getElementById("msg-so");

  dadoProAtv = document.getElementById("h4-proatv");
  alertaProAtv = document.getElementById("msg-proatv");

  dadoProIntv = document.getElementById("h4-proIntv");
  alertaProIntv = document.getElementById("msg-proIntv");

  let maquina = document.getElementById("listaMaquinas").value

  console.log("maquina: ", maquina);

  fetch("/dashAnalistaProcesso/dadosCards", {
    method: "POST",
    headers: {
      "Content-Type": "application/json"
    },
